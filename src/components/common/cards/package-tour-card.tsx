...
const TourPackageCard = ({ packagetour }: TourPackageCardProps) => {
  return (
    <div className='group relative card 2xl:max-w-[90%] xl:max-w-[75%] sm:max-w-[85%] max-w-[95%] xl:w-[30rem] lg:w-[22rem] sm:w-[28rem] w-[90%] shadow-xl  bg-neutral-light sm:h-[26rem] h-[22rem] rounded-2xl overflow-hidden hover:shadow-2xl transition-shadow duration-300 m-0'>
      {/* Image Section */}
      ...
      <div className='card-body px-4 py-4 max-h-[60%] justify-between gap-2 '>
        ...
        {/* Pricing Section */}
        <div className='bg-gray-200 rounded-xl border-gray-300 w-full border sm:p-4 py-2 px-4 flex flex-row justify-between items-center'>
